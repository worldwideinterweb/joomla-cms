...
// $Id: adminconfig.php 3395 2011-10-12 17:00:11Z aha $
/****************************************************************************************\
**   JoomGallery 2                                                                      **
...
class JoomAdminConfig extends JoomConfig
{
   ...
   * @since   1.5.5
   */
  function save($newconfig = null, $id = false, $existing_row = 0, $group_id = 0)
  {
  ...
  function saveCSS()
  {
    $icon_url = JURI::root().'media/joomgallery/images/';
