...
<?php
    ...
    JHTML::_('joomconfig.row', 'jg_dateformat', 'custom', 'COM_JOOMGALLERY_CONFIG_GS_PD_TIME', $mc_jg_dateformat);
...
JHTML::_('joomconfig.start', 'page4');
    ...
    JHTML::_('joomconfig.row', 'jg_wrongvaluecolor', 'text', 'COM_JOOMGALLERY_CONFIG_GS_BU_WRONG_VALUE_COLOR', $this->_config->jg_wrongvaluecolor);
JHTML::_('joomconfig.end');
...
JHTML::_('joomconfig.start', 'page10');
    ...
    JHTML::_('joomconfig.row', 'jg_dyncropbgcol', 'text', 'COM_JOOMGALLERY_CONFIG_FS_GS_DYNCROP_BGCOL', $this->_config->jg_dyncropbgcol);
...
?>
    <tr align="center" valign="middle">
      <td align="left" valign="top"><strong><?php echo JText::_('COM_JOOMGALLERY_CONFIG_FS_PF_OPENJS_BACKGROUND'); ?></strong></td>
      <td align="left" valign="top"><input type="text" name="jg_openjs_background" value="<?php echo $this->_config->jg_openjs_background; ?>" /></td>
      <td align="left" valign="top"><?php echo JText::_('COM_JOOMGALLERY_CONFIG_FS_PF_OPENJS_BACKGROUND_LONG') . ' ' . JText::_('COM_JOOMGALLERY_CONFIG_COMMON_STYLE_COLOR_HEX'); ?></td>
    </tr>
    <tr align="center" valign="middle">
      <td align="left" valign="top"><strong><?php echo JText::_('COM_JOOMGALLERY_CONFIG_FS_PF_DHTML_BORDER'); ?></strong></td>
      <td align="left" valign="top"><input type="text" name="jg_dhtml_border" value="<?php echo $this->_config->jg_dhtml_border; ?>" /></td>
      <td align="left" valign="top"><?php echo JText::_('COM_JOOMGALLERY_CONFIG_FS_PF_DHTML_BORDER_LONG') . ' ' . JText::_('COM_JOOMGALLERY_CONFIG_COMMON_STYLE_COLOR_HEX'); ?></td>
    </tr>
<?php
...
JHTML::_('joomconfig.start', 'page22');
    ...
    JHTML::_('joomconfig.row', 'jg_geotagging', 'text', 'COM_JOOMGALLERY_CONFIG_DV_ED_GEOTAGGING', $this->_config->jg_geotagging);
?>
  </table><p />
