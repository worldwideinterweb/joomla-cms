...
<table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminlist">
  ...
  <tr align="center" valign="middle">
    <td align="right" width="50%">
      <?php echo JText::_('COM_JOOMGALLERY_COMMON_IMAGE_PATH'); ?>:
    </td>
...
<?php if(count($this->subdirectories)): ?>
  <tr>
    <td align="right">
      <?php echo JText::_('COM_JOOMGALLERY_UPLOAD_SELECT_DIRECTORY'); ?>:
    </td>
    <td align="left">
...
<?php   endforeach; ?>
        ...
        <input type="submit" value="<?php echo JText::_('COM_JOOMGALLERY_UPLOAD_CHANGE_FOLDER'); ?>" />
      </form>
    </td>
  </tr>
<?php endif; ?>
...
<form action="index.php" method="post" name="adminForm" enctype="multipart/form-data" onsubmit="return joom_checkme();">
  <table width="100%" border="0" cellpadding="4" cellspacing="2" class="adminlist">
    <tr>
      <td align="right" width="50%">
        <?php echo JText::_('COM_JOOMGALLERY_UPLOAD_PLEASE_SELECT_IMAGES'); ?>:
      </td>
      <td align="left">
...
<?php endif; ?>
    ...
    <tr>
      <td align="right">
        <?php echo JText::_('COM_JOOMGALLERY_UPLOAD_DELETE_AFTER_UPLOAD'); ?>
      </td>
      <td align="left">
