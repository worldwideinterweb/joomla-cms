...
if ( $this->state->parent && ($this->state->folder != $this->state->default_folder)) {
?>
<div class="item">
	<a href="index.php?option=<?php echo $this->state->option ?>&amp;view=files&amp;tmpl=component&amp;folder=<?php echo $this->state->parent ?>">
		<img src="<?php echo JURI::base() ?>components/<?php echo $option; ?>/support/images/folderup_32.png" width="32" height="32" />
