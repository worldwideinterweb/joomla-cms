...
else {$bgmodulemedia="mod_blank17v11";}

//Select surrounds source folder

$surmodulemedia='mod_blank17v11';
...
if ($surroundstyle=="custom"){$surroundpx=$custompx;$surmodulemedia="mod_blank17v11";}

//colours & backgrounds

$bgpattern = $params->get('bgpattern');

if($bgpattern == "custom"){$bgmodulemedia="mod_blank17v11";}
...
"td.corner1_" . $modno_bm ."{padding:0;margin:0;background:url(".$url."modules/".$surmodulemedia."/tmpl/images/surrounds/" .
    $surroundstyle . "/" . $keycolour .
    "/corner1.png) no-repeat ;

}
td.corner2_" . $modno_bm .
    "{padding:0;margin:0;background:url(".$url."modules/".$surmodulemedia."/tmpl/images/surrounds/" .
    $surroundstyle . "/" . $keycolour .
