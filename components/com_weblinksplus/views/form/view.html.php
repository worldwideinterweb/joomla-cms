 ...
 * @since		1.5
 */
class WeblinksplusViewForm extends JView
{
	protected $form;
	protected $item;
	...
	public function display($tpl = null)
	{
		...
		if (empty($this->item->id)) {
			$authorised = ($user->authorise('core.create', 'com_weblinksplus') || (count($user->getAuthorisedCategories('com_weblinksplus', 'core.create'))));
		}
		else {
			$authorised = $user->authorise('core.edit', 'com_weblinksplus.weblinkplus.'.$this->item->id);
		}
	...
	protected function _prepareDocument()
	{
		...
		if (empty($this->item->id)) {
		$head = JText::_('COM_WEBLINKSPLUS_FORM_SUBMIT_WEBLINK');
		}
		else {
		$head = JText::_('COM_WEBLINKSPLUS_FORM_EDIT_WEBLINK');
		}
