 ...
 * @since		1.5
 */
class WeblinksplusModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__weblinksplus` AS a');
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$user = JFactory::getUser();
		if ((!$user->authorise('core.edit.state', 'com_weblinksplus')) &&  (!$user->authorise('core.edit', 'com_weblinksplus'))){
	...
	public function getCategory()
	{
		if(!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Weblinksplus', $options);
