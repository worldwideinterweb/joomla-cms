...
// $Id: messenger.php 3378 2011-10-07 18:37:56Z aha $
/****************************************************************************************\
**   JoomGallery 2                                                                      **
...
class JoomMessenger extends JObject
{
  ...
  function _sendMsg()
  {
    ...
    if(isset($this->_message['from']) && $this->_message['from'] && is_numeric($this->_message['from']) && $this->_message['from'])
    {
      $from = $this->_message['from'];
    }
    else
    {
      // TODO: Select a super administrator
      $db->setQuery(" SELECT
                        id
                      FROM
                        #__users
    ...
    JModel::addIncludePath(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_messages'.DS.'models', 'MessagesModel');
