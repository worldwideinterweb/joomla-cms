...
class JoomGalleryViewDownloadzip extends JoomGalleryView
{
  ...
  function display($tpl = null)
  {
    ...
    {
      $this->_mainframe->redirect(JRoute::_('index.php?view=favourites', false), JText::_('COM_JOOMGALLERY_ZIPFILE_NOT_FOUND'), 'error');
    }
    ...
    if($zipsize < 1000000)
    {
      ...
      $zipsize_string = $zipsize.' '.JText::_('COM_JOOMGALLERY_DETAIL_KB');
    }
    else
    {
      $zipsize        = round($zipsize, -6) / 1000000;
      $zipsize_string = $zipsize.' '.JText::_('COM_JOOMGALLERY_DETAIL_MB');
    }
