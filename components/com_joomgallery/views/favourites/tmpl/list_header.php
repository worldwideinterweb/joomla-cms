...
<?php endif;
  ...
  <?php switch($this->params->get('show_favourites', 1)):
    ...
    <?php break;
          case 5: ?>
    <a href="<?php echo JRoute::_('index.php?task=createzip'); ?>"<?php echo JHTML::_('joomgallery.tip', 'COM_JOOMGALLERY_DOWNLOADZIP_CREATE_TIPTEXT', 'COM_JOOMGALLERY_DOWNLOADZIP_DOWNLOAD', true); ?>><?php echo JText::_('COM_JOOMGALLERY_DOWNLOADZIP_DOWNLOAD'); ?>
