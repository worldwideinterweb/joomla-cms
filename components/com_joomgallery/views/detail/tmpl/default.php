...
<?php endif;
      ...
      <a href="<?php echo JRoute::_('index.php?task=selectnametag&tmpl=component'); ?>" class="modal<?php echo JHTML::_('joomgallery.tip', 'COM_JOOMGALLERY_DETAIL_NAMETAGS_SELECT_OTHERS_TIPTEXT', 'COM_JOOMGALLERY_DETAIL_NAMETAGS_SELECT_OTHERS_TIPCAPTION'); ?>" rel="{handler:'iframe', size:{x:200,y:100}}">
...
<?php endif;
      ...
      <a href="<?php echo JRoute::_('index.php?task=report&id='.$this->image->id.'&tmpl=component'); ?>" class="modal<?php echo JHTML::_('joomgallery.tip', 'COM_JOOMGALLERY_COMMON_REPORT_IMAGE_TIPTEXT', 'COM_JOOMGALLERY_COMMON_REPORT_IMAGE_TIPCAPTION'); ?>" rel="{handler:'iframe'}"><!--, size:{x:200,y:100}-->
...
<?php endif;
      ...
      <a href="javascript:if(confirm('<?php echo JText::_('COM_JOOMGALLERY_COMMON_ALERT_SURE_DELETE_SELECTED_ITEM', true); ?>')){ location.href='<?php echo JRoute::_('index.php?task=delete&id='.$this->image->id, false);?>';}"<?php echo JHTML::_('joomgallery.tip', 'COM_JOOMGALLERY_COMMON_DELETE_IMAGE_TIPTEXT', 'COM_JOOMGALLERY_COMMON_DELETE_IMAGE_TIPCAPTION', true); ?>>
...
<?php   endif;
      ...
      <div class="sectiontableentry<?php $this->i++; echo ($this->i%2)+1; ?>">
        ...
        <div class="jg_photo_right" id="jg_photo_filesizedtl">
          ...
          (<?php echo $this->image->img_width; ?> x <?php echo $this->image->img_height; ?> <?php echo JText::_('COM_JOOMGALLERY_DETAIL_PX'); ?>)
        </div>
      </div>
<?php   endif;
...
<?php   endif;
      ...
      <div class="sectiontableentry<?php $this->i++; echo ($this->i%2)+1; ?>">
        ...
        <div class="jg_photo_right" id="jg_photo_filesizeorg">
          ...
          (<?php echo $this->image->orig_width; ?> x <?php echo $this->image->orig_height; ?> <?php echo JText::_('COM_JOOMGALLERY_DETAIL_PX'); ?>)
        </div>
      </div>
<?php   endif;
...
<h2 id="" class="itemTitle" style="visibility: visible;">
<script type='text/javascript'>
var _CI = _CI || {};
(function() {
