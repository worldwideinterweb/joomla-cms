...
// $Id: detail.php 3378 2011-10-07 18:37:56Z aha $
/****************************************************************************************\
**   JoomGallery 2                                                                      **
...
class JoomGalleryModelDetail extends JoomGalleryModel
{
  ...
  function getImage()
  {
    ...
    if(empty($this->_image))
    {
      ...
      if(JFile::exists($orig))
      {
        ...
        $image->orig_size     = number_format($orig_size / 1024, 2, JText::_('COM_JOOMGALLERY_COMMON_DECIMAL_SEPARATOR'), JText::_('COM_JOOMGALLERY_COMMON_THOUSANDS_SEPARATOR'))." ".JText::_('COM_JOOMGALLERY_DETAIL_KB');
      }
      else
      {
      ...
      // Populate additional parameters, if available
      if($image->params)
      {
        $image->params = new JParameter($image->params);
      }
  ...
  function _loadImages()
  {
    ...
    if(empty($this->_images))
    {
      ...
      {
        $this->_mainframe->redirect(JRoute::_('index.php?view=gallery', false), JText::sprintf('Image with ID %d not found', $this->_id), 'error');
      }
